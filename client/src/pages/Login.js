      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl px-8 py-10 sm:px-10 fade-in">
          <div className="flex flex-col items-center mb-8">
            ...
            <button
              onClick={() => window.location.href = 'http://localhost:8001/api/auth/google'}
              className="mt-4 w-full flex items-center justify-center gap-2 py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 text-gray-700 font-semibold text-base transition-colors"
              type="button"
            >
